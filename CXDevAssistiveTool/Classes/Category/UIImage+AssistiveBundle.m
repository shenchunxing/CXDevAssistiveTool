...
+ (UIImage *)as_imageWithName:(NSString *)imageName {
    ...
    NSString *bundlePath = [NSString stringWithFormat:@"%@/%@.bundle",mainBundlePath,@"CXDevAssistiveTool"];
    NSBundle *bundle = [NSBundle bundleWithPath:bundlePath];
    if (bundle == nil) {
        bundlePath = [NSString stringWithFormat:@"%@/Frameworks/%@.framework/%@.bundle",mainBundlePath,@"CXDevAssistiveTool",@"CXDevAssistiveTool"];
