...
@implementation CXAssistivePoint

+ (instancetype)pointWithX:(CGFloat)x y:(CGFloat)y {

    CXAssistivePoint *point = [[CXAssistivePoint alloc] init];
    point.pointX = x;
    point.pointY = y;
    return point;
}
...
@interface CXAssisticeDetectionView ()<UIScrollViewDelegate>
...
@implementation CXAssisticeDetectionView
...
- (void)drawLineInPoints {
    ...
    CXAssistivePoint *p = self.pointList[0];
...
- (void)showTipWithValue:(NSString *)value atPoint:(CXAssistivePoint *)p {
