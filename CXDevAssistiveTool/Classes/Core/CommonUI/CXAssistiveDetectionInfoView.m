//
//  CXAssistiveDetectionInfoView.m
//  CXDevAssistive
//
...
@interface CXAssistiveDetectionInfoView ()
...
@implementation CXAssistiveDetectionInfoView
...
- (void)initial {
    ...
    self.detectionView = [[CXAssisticeDetectionView alloc] initWithFrame:CGRectMake(10, self.titleLbl.as_bottom+8, self.as_width-10-50, self.as_height-self.titleLbl.as_bottom-8-8)];
