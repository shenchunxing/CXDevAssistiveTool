...
@interface CXUrlSessionDemuxTaskInfo : NSObject
...
@interface CXUrlSessionDemuxTaskInfo ()
...
@implementation CXUrlSessionDemuxTaskInfo
...
@interface CXAssistiveURLSessionDemux ()<NSURLSessionDataDelegate>
...
@implementation CXAssistiveURLSessionDemux
...
- (NSURLSessionDataTask *)dataTaskWithRequest:(NSURLRequest *)request delegate:(id<NSURLSessionDataDelegate>)delegate modes:(NSArray *)modes {
    ...
    CXUrlSessionDemuxTaskInfo *taskInfo;
    assert(request != nil);
    assert(delegate != nil);
    // modes may be nil
    ...
    assert(task!=nil);
    taskInfo = [[CXUrlSessionDemuxTaskInfo alloc] initWithTask:task delegate:delegate modes:modes];
    @synchronized (self) {
...
- (CXUrlSessionDemuxTaskInfo *)taskInfoForTask:(NSURLSessionTask *)task {
    
    assert(task!=nil);
    CXUrlSessionDemuxTaskInfo *result;
    @synchronized (self) {
