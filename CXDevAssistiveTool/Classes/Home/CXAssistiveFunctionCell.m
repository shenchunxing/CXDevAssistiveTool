...
@interface CXAssistiveItemCell : UICollectionViewCell

@property (nonatomic, strong) UIImageView *iconImgView;

@property (nonatomic, strong) UILabel *titleLbl;

- (void)bindModel:(CXAssistiveFunctionModel *)model;

@end

@interface CXAssistiveFunctionCell ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (nonatomic, strong) CXAssistiveFunctionViewModel *viewModel;

@end

@implementation CXAssistiveFunctionCell
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CXAssistiveItemCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"CXAssistiveItemCell" forIndexPath:indexPath];
    CXAssistiveFunctionModel *model = self.viewModel.functionModels[indexPath.item];
...
- (UICollectionView *)collectView {
    ...
    if (!_collectView) {
        ...
        [_collectView registerClass:[CXAssistiveItemCell class] forCellWithReuseIdentifier:@"CXAssistiveItemCell"];
    }
    return _collectView;
}
...
@implementation CXAssistiveItemCell
