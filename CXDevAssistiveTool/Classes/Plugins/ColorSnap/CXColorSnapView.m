...
@implementation CXColorSnapView
...
- (void)updateScreenshot {
    //截1x图
    self.screenshotImg = [[CXScreenShotHelper sharedInstance] imageFromCurrentScreen:1];
}
