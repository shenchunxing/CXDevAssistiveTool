//
//  CXNetworkEnvironmentEditViewController.m
//  CXDevAssistive
//
...
@interface CXNetworkDetailCell : UITableViewCell
...
@interface CXNetworkEnvironmentEditViewController ()<UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate>

@property (strong, nonatomic) UITableView *tableView;
@property (strong, nonatomic) NSMutableArray <CXNetworkConfigur *> *itemConfigurs;
@property (copy, nonatomic) NSString *identifier;

@end

@implementation CXNetworkEnvironmentEditViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [CXNetworkDetailCell heightForCell];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    CXNetworkDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CXNetworkDetailCell"];
    if (!cell) {
        cell = [[CXNetworkDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CXNetworkDetailCell"];
    }
    CXNetworkConfigur *configur = self.itemConfigurs[indexPath.row];
...
- (NSArray<UITableViewRowAction *> *)tableView:(UITableView *)tableView editActionsForRowAtIndexPath:(NSIndexPath *)indexPath {
    return @[[UITableViewRowAction rowActionWithStyle:UITableViewRowActionStyleDefault title:@"删除" handler:^(UITableViewRowAction * _Nonnull action, NSIndexPath * _Nonnull indexPath) {
        CXNetworkConfigur *config = self.itemConfigurs[indexPath.row];
...
- (void)addConfigurButtonOnClicked {
    ...
    UIAlertAction *saveAction = [UIAlertAction actionWithTitle:@"保存" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        CXNetworkConfigur *configur = [CXNetworkConfigur configurWithAddress:walertController.textFields.firstObject.text remark:walertController.textFields.lastObject.text];
...
@implementation CXNetworkDetailCell
