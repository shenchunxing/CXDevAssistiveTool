//
//  CXAssistiveHttpDetailViewController.m
//  CXDevAssistive
//
...
@interface CXAssistiveDetailCell : UITableViewCell
...
@interface CXAssistiveHttpDetailViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSDateFormatter *dateFormatter;
/* 数据 */
@property (nonatomic, strong) CXAssistiveHttpModel *httpModel;
@end

@implementation CXAssistiveHttpDetailViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CXAssistiveDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CXAssistiveDetailCell"];
    if (!cell) {
        cell = [[CXAssistiveDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"CXAssistiveDetailCell"];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CXAssistiveContentViewController *vc = nil;
    if (indexPath.row == 0) {
        vc = [[CXAssistiveContentViewController alloc] init];
    ...
    if (indexPath.row == 8 && self.httpModel.responseData.length > 0) {
        ...
        if (self.httpModel.isImage) {
            ...
            vc.content = [CXAssistiveURLUtil convertJsonFromData:self.httpModel.responseData];
        }
    }
    if (vc) {
...
@implementation CXAssistiveDetailCell
