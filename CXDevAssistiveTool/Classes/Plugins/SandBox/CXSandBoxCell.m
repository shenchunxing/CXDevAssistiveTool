...
- (void)renderUIWithModel:(CXSandBoxModel *)model {
    ...
    NSUInteger size = [CXAssistiveUtil fetchFileSizeAtPath:model.path];
    self.sizeLbl.text = [CXAssistiveUtil formatByte:size];
}
