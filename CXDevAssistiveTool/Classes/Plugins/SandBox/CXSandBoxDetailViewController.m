//
//  CXSandBoxDetailViewController.m
//  CXDevAssistive
//
...
@interface CXSandBoxDetailViewController ()<QLPreviewControllerDataSource,QLPreviewControllerDelegate>

@property (nonatomic, strong) UITextView *textView;

@end

@implementation CXSandBoxDetailViewController
