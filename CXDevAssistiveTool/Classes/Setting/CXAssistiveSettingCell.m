...
@interface CXAssistiveSettingCell ()
...
@property (nonatomic, strong) CXAssistiveSettingModel *bindedModel;
@end

@implementation CXAssistiveSettingCell
